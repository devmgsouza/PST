...
public class FragShopNavTransactionOptions {
    ...
    private FragShopNavTransactionOptions(Builder builder) {
    ...
    public static final class Builder {
        ...
        public FragShopNavTransactionOptions build() {
            return new FragShopNavTransactionOptions(this);
        }
    }
}
