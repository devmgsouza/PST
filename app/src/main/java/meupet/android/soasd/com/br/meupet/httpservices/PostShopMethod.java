...
public class PostShopMethod extends AsyncTask<String, Void, String> {
    String postGson;
    String metodo;
    String mensagem;
    ProgressDialog pdia;
    ...
    public PostShopMethod(String postGson, String metodo, Context context, Callback callback, String mensagem) {
        this.metodo = metodo;
    ...
    public PostShopMethod(String postGson, String metodo) {
        this.postGson = postGson;
        this.metodo = metodo;
    }
    ...
    protected String doInBackground(String... param) {
        ...
        //String url =  "http://ec2-54-207-110-122.sa-east-1.compute.amazonaws.com:8080/PSTSHOP/rest/shop" + metodo;
        //String url =  "http://192.168.43.239:8080/PSTSHOP/rest/shop" + metodo;
        String url =  "https://ec2-18-231-108-89.sa-east-1.compute.amazonaws.com:8443/pstshop/rest/shop" + metodo;
