package meupet.android.soasd.com.br.meupet.views;
...
public class FragShopNavController {
    ...
    private static final String EXTRA_TAG_COUNT = FragShopNavController.class.getName() + ":EXTRA_TAG_COUNT";
    private static final String EXTRA_SELECTED_TAB_INDEX = FragShopNavController.class.getName() + ":EXTRA_SELECTED_TAB_INDEX";
    private static final String EXTRA_CURRENT_FRAGMENT = FragShopNavController.class.getName() + ":EXTRA_CURRENT_FRAGMENT";
    private static final String EXTRA_FRAGMENT_STACK = FragShopNavController.class.getName() + ":EXTRA_FRAGMENT_STACK";
    ...
    private FragShopNavController(Builder builder, @Nullable Bundle savedInstanceState) {
    ...
    public static final class Builder {
        ...
        public FragShopNavController build() {
            if (mRootFragmentListener == null && mRootFragments == null) {
                throw new IndexOutOfBoundsException("Either a root fragment(s) needs to be set, or a fragment listener");
            }
            return new FragShopNavController(this, mSavedInstanceState);
        }
