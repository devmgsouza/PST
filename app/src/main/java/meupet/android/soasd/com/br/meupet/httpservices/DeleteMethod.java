...
public class DeleteMethod extends AsyncTask<String, Void, String> {
    String parametro;
    Context context;
    Callback callback;
    ProgressDialog pdia;
    String mensagem;
    private static String TAG = "DeleteMethod";

    public DeleteMethod(String parametro, Context context, Callback callback, String mensagem){
